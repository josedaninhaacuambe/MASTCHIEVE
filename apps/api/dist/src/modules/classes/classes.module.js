...
exports.ClassesModule = ClassesModule = __decorate([
    (0, common_1.Module)({ controllers: [classes_controller_1.ClassesController], providers: [classes_service_1.ClassesService], exports: [classes_service_1.ClassesService] })
], ClassesModule);
