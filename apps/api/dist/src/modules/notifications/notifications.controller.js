...
let NotificationsController = class NotificationsController {
    ...
    getMyNotifications(userId, q) {
        return this.service.getUserNotifications(userId, Number(q.page) || 1, Number(q.limit) || 20);
    }
    markAllRead(userId) { return this.service.markAllRead(userId); }
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar notificações do utilizador' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Enviar notificação em massa' }),
...
exports.NotificationsController = NotificationsController = __decorate([
    ...
    __metadata("design:paramtypes", [notifications_service_1.NotificationsService, notifications_gateway_1.NotificationsGateway])
